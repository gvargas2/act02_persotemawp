...
function modificar_post_object() {
    ...
    $labels->view_item = 'Ver Servicios';
    $labels->search_items = 'Buscar Servicios';
    $labels->not_found = 'No se han encontrado Serivio';
    $labels->not_found_in_trash = 'No se han encontrado Servicio en la papelera';
    $labels->all_items = 'Todos los Servicios';
